  ...
  if (rides.length === 0) {
    return (
      <div className="text-center py-12 text-gray-400 dark:text-gray-500">
        <div className="mb-3">
          <svg className="w-10 h-10 mx-auto text-gray-300 dark:text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="space-y-2">
      {sorted.map(ride => (
        <div
          key={ride.id}
          className="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 p-4 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow"
        >
          ...
          <div className="flex items-center gap-3">
            ...
            {showConfirm === ride.id ? (
              <div className="flex gap-1">
                ...
                >
                  ...
                  <button
                    ...
                    className="px-2 py-1 text-xs bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors"
                  >
                    {t('history.nao')}
                  </button>
              </div>
              ...
              <button
                ...
                className="text-gray-300 dark:text-gray-600 hover:text-loss transition-colors"
